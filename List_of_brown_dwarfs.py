...
nd1 = pd.read_csv("brown_dwarfs.csv")
nd1 = nd1.dropna()

nd1['mass'] = nd1['mass'].astype(float)
nd1['radius'] = nd1['radius'].astype(float)

nd1['mass'] = nd1['mass'].mul(0.102763)
nd1['radius'] = nd1['radius'].mul(0.000954588)

sf = pd.read_csv("brown_dwarfs.csv")
final = pd.merge(sf,nd1)
